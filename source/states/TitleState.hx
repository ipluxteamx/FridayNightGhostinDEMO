...
class TitleState extends MusicBeatState
{
	...
	public static var introed:Bool = false;

	// freakyMenu
	public static var menuMusic:String = 'fng/menuShit';
	// 107
	public static var titleBpm:Int = 180;
	// 0.7
	public static var soundVolume:Float = 0.5;
	...
	override public function create():Void
	{
		...
		// IGNORE THIS!!!
		titleJSON = Json.parse(Paths.getTextFromFile('images/titleShit.json'));
	...
	override function update(elapsed:Float)
	{
		...
		FlxG.camera.zoom = FlxMath.lerp(1, FlxG.camera.zoom, FlxMath.bound(1 - (elapsed * 3.125 * camZoomingDecay), 0, 0.825));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					//FlxG.sound.music.stop();
					FlxG.sound.playMusic(Paths.music(menuMusic), soundVolume);
